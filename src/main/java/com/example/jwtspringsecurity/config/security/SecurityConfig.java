    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // Exiger le rôle ADMIN pour accéder aux endpoints commençant par "/api/products/admin/**".
                        .requestMatchers("/api/products/admin/**").hasRole("ADMIN")

                        // Exiger les rôles ADMIN ou SELLER pour accéder aux endpoints commençant par "/api/products/**".
                        .requestMatchers("/api/products/**").hasAnyRole("ADMIN", "SELLER")

                        // Exiger les rôles ADMIN, SELLER, ou CUSTOMER pour accéder à tous les autres endpoints commençant par "/api/**".
                        .requestMatchers("/api/**").hasAnyRole("ADMIN", "SELLER", "CUSTOMER")
